...
router.post("/posts", protect, communityPostLimiter, upload.single("file"), validateRequest(createPostSchema), createPost);
...
router.put("/posts/:id", protect, upload.single("file"), validateRequest(updatePostSchema), updatePost);
