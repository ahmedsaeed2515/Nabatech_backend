...
var garden_model_1 = require("../models/garden_model");
var zone_model_1 = require("../models/zone_model");
...
exports.growthMeasurementSchema = zod_1.z.object({
    heightCm: zod_1.z.preprocess(function (val) { return Number(val); }, zod_1.z.number().positive().optional()),
    leafCount: zod_1.z.preprocess(function (val) { return Number(val); }, zod_1.z.number().int().nonnegative().optional()),
    stage: zod_1.z.enum(['SEED', 'SPROUT', 'VEGETATIVE', 'FLOWERING', 'FRUITING', 'MATURE', 'DEAD']).optional()
}).refine(function (data) { return data.heightCm !== undefined || data.leafCount !== undefined || data.stage !== undefined; }, {
