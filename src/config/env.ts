...
const envSchema = z.object({
  ...
  JWT_REFRESH_SECRET: z.string().min(1, "JWT_REFRESH_SECRET is required").default('test-secret'),
  TOKEN_HASH_SECRET: z.string().min(1, "TOKEN_HASH_SECRET is required").default('test-secret'),
