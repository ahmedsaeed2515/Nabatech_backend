...
var IdempotencyRecordSchema = new mongoose_1.Schema({
    ...
    resultReference: { type: mongoose_1.Schema.Types.Mixed },
    expiresAt: { type: Date, required: true }
}, { timestamps: true });
IdempotencyRecordSchema.index({ actor: 1, scope: 1, key: 1 }, { unique: true });
IdempotencyRecordSchema.index({ expiresAt: 1 }, { expireAfterSeconds: 0 });
exports.default = mongoose_1.default.model('IdempotencyRecord', IdempotencyRecordSchema);
