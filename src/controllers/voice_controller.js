...
var VoiceController = /** @class */ (function () {
    ...
    VoiceController.processVoiceCommand = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var userId, _a, audioBase64, language, voiceService, result, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        userId = req.user._id.toString();
                        _a = req.body, audioBase64 = _a.audioBase64, language = _a.language;
                        if (!audioBase64) {
                            res.status(400).json({ success: false, message: 'audioBase64 is required' });
                            return [2 /*return*/];
                        }
                        voiceService = new VoiceService_1.VoiceService();
                        return [4 /*yield*/, voiceService.processCommand(audioBase64, userId, language || 'ar')];
                    case 1:
                        result = _b.sent();
