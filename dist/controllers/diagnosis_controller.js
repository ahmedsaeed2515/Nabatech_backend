...
exports.generateDiagnosisAdvice = exports.syncOfflineDiagnosis = exports.predictPlantDisease = void 0;
...
const predictPlantDisease = async (req, res) => {
    ...
    try {
        ...
        const cnnResult = await (0, ai_orchestrator_service_1.orchestrateAssistantRequest)({
            userId,
        ...
        const llmResult = await (0, ai_orchestrator_service_1.orchestrateAssistantRequest)({
            userId,
            question: prompt,
            history: [],
        });
        ...
        const historyRecord = await diagnosis_history_model_1.default.create({
            ...
            confidence,
            severity,
            candidates: candidates.map((c) => ({ label: c.label, confidence: c.confidence })),
            isOffline: false,
        ...
        console.error("Diagnosis error:", (0, ai_errors_1.sanitizeErrorMessage)(error));
        if (uploadedImagePublicId) {
            ...
            try {
                ...
                console.error("Failed to cleanup Cloudinary on diagnosis error:", (0, ai_errors_1.sanitizeErrorMessage)(delErr));
            }
        }
