...
const AdminAuditSchema = new mongoose_1.Schema({
    ...
    beforeSummary: { type: mongoose_1.Schema.Types.Mixed },
    afterSummary: { type: mongoose_1.Schema.Types.Mixed },
    createdAt: { type: Date, default: Date.now }
});
AdminAuditSchema.index({ actor: 1, createdAt: -1 });
AdminAuditSchema.index({ targetType: 1, targetId: 1, createdAt: -1 });
exports.default = mongoose_1.default.model('AdminAudit', AdminAuditSchema);
