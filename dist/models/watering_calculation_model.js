...
const wateringCalculationSchema = new mongoose_1.Schema({
    user: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, index: true },
    plantType: { type: String, required: false, trim: true },
    plantLibraryId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Plant", required: false },
...
exports.default = mongoose_1.default.model("WateringCalculation", wateringCalculationSchema);
