...
const expertChatSessionSchema = new mongoose_1.Schema({
    farmerId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, index: true },
    expertId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, index: true },
...
exports.default = mongoose_1.default.model("ExpertChatSession", expertChatSessionSchema);
