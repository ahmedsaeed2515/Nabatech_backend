...
const redis_cache_1 = require("../utils/redis_cache");
class AiOrchestratorService {
    ...
    async processChat(userId, message) {
        ...
        return (0, redis_cache_1.getOrSetCache)(cacheKey, 300, async () => {
            try {
    ...
    async analyzeGarden(userId) {
        ...
        return (0, redis_cache_1.getOrSetCache)(cacheKey, 3600, async () => {
            try {
                const response = await this.ai.models.generateContent({
                    model: 'gemini-2.5-flash',
